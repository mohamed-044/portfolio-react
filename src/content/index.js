...
export default {
  ...
  header: {
    ...
    text: ['Salut!', "Bienvenue sur mon Portfolio", 'Je suis '],
    typical: [
      'Mohamed Boulatika !',
      2000,
  ...
  stack: {
    ...
    tech: [
      {
        img: process.env.PUBLIC_URL + '/assets/c.png',
        alt: 'mongodb',
      },
      {
        img: process.env.PUBLIC_URL + '/assets/cpp.png',
        alt: 'react',
      },
      {
    ...
    desc: `Diplômé en BTS Systèmes Numériques Option Informatique et Réseaux, étudiant en bachelor Développement Web et Application, passionné par les nouvelles technologies. Je possède des compétences solides en programmation renforcées par des expériences pratiques en stages. Motivé, je cherche à intégrer une entreprise dynamique pour développer davantage mes compétences en alternance.`,
  },
};
